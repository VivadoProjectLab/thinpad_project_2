...
initial begin 
    //在这里可以自定义测试输入序列，例如：
    touch_btn = 0;
    for (integer i = 0; i < 200; i = i++) begin
        #20; //等待100ns
...
initial begin
    for(integer i=0;i<50;i=i++) begin
        dip_sw = 32'b00000000000000000000000000000001;
        #40;
        dip_sw = 32'b00000000000000000000000000000010;
        #40;
        dip_sw = 32'b00000000000000000000000000000000;
        #40;
        dip_sw = 32'b00000000000000000000000000000000;
        #40;
    end
